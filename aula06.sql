...
from tbl_titulo t left join tbl_livros l
on t.codigo_titulo = l.codigo_titulo;

--2 Liste os títulos e suas descrições dos livros alugados (retorna 4 linhas)
select t.titulo, t.descricao, l.status
from tbl_titulo t join tbl_livros l
on t.codigo_titulo = l.cod_livro where l.status = 'ALUGADO';
